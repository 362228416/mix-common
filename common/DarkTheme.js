...
// const primaryColor = '#5d4bcf';
// const primaryColor = '#2f2f2f';
// const primaryColor = '#3a3839';
const primaryColor = '#3E77FE';
//secondary color
...
export default {
    ...
    tvBarSeparatorColor: '#bbb',
    tvBarBtnWidth: 44,
    tvBarBtnIconSize: 22,
    tvBarBtnIconTintColor: '#7b7e82',
    // tvBarBtnIconActiveTintColor: '#51aa38',
    tvBarBtnIconActiveTintColor: '#459ae4',
    tvBarBtnTitleColor: '#7b7e82',
    tvBarBtnTextFontSize: 10,
    tvBarBtnActiveTitleColor: '#459ae4',
    // tvBarBtnActiveTitleColor: '#51aa38',
